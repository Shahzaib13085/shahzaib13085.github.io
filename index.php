...
<div class="container">
        <h2 class="text-center pt-4" id="customerdetail" style="color : black;font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif' cursive;">Customers Details</h2>
        <br>
